...
fun FeedListScreen(
    ...
    Scaffold { innerPadding: PaddingValues ->
        Column(
            ...
            PrimaryButton(
                text = if (state.isLoading) "Loading feed..." else "Refresh Feed",
                enabled = !state.isLoading,
                onClick = onRefresh,
            )
            PrimaryButton(
                text = "Open Saved Posts",
...
private fun FeedPostCard(
    ...
    Card(
        ...
        Column(
            ...
            PrimaryButton(
                text = if (post.viewerState.saved) "Unsave Post" else "Save Post",
                loading = isUpdating,
