...
@MainActor
public final class ApplicationJourneyViewModel: ObservableObject, ManagedTask {
    @Published public var journey: ApplicationJourney?
    ...
    // MARK: - Mock Data
    public static let mockJourney = ApplicationJourney(
